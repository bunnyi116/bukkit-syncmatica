...
public class SyncmaticManager {
    ...
    public SyncmaticManager(SyncmaticaContext syncmaticaContext) {
    ...
    private void saveServer() {
        ...
        final File backup = new File(context.configFolder, "placements.json.bak");
        final File incoming = new File(context.configFolder, "placements.json.new");
        final File current = new File(context.configFolder, "placements.json");
    ...
    private void loadServer() {
        final File f = new File(context.configFolder, "placements.json");
